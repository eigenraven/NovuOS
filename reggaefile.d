...
const uefi_obj_btypes = Target(`$project/output/uefi_btypes.obj`, UEFI_DC~`-of=$out $in`, Target(`$project/source/kernel/novuos/basictypes.d`));
const uefi_obj_pager = Target(`$project/output/uefi_pager.obj`, UEFI_DC~`-of=$out $in`, Target(`$project/source/kernel/novuos/memory/pager.d`));
...
const uefi_app = Target(`$project/output/BOOTX64.EFI`, UEFI_LD~`-o $out $in -lgcc`, [uefi_obj_dmain, uefi_obj_pager, uefi_obj_btypes]);
